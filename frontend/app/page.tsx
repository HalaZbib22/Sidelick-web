...
const TESTIMONIALS = [
  ...
  { initials: "KM", name: "Karim M.", city: "Jounieh", quote: "The same walker every morning, and I can see exactly when they arrive. Total peace of mind." },
  { initials: "RH", name: "Rana H.", city: "Byblos", quote: "Walk Share saved me 20% and my dog made a new friend on every group walk. Win-win." },
  { initials: "TD", name: "Tarek D.", city: "Tripoli", quote: "Verification gave me real confidence. I knew exactly who was coming to care for my dog." },
];
    ...
    <main className="min-h-screen">
          ...
          <div className="relative w-[250px] rounded-[2.6rem] bg-foreground p-2.5 shadow-xl">
            <div className="overflow-hidden rounded-[2.1rem] bg-background">
              ...
              <div className="flex items-center justify-between px-4 pb-3 pt-4">
                <span className="inline-flex items-center gap-1 text-sm font-display font-semibold text-primary">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-16">
        <div className="rounded-[2rem] bg-primary px-8 py-12 text-center text-primary-foreground shadow-glow">
          ...
          <p className="mx-auto mt-2 max-w-md text-sm opacity-90">
            Join pet owners across Lebanon booking trusted care in minutes.
          </p>
          <MagneticLink
            href={buildSignupPath("user")}
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-6 py-8 text-sm text-muted-foreground sm:flex-row">
          <Logo className="text-sm font-medium" />
